            ...
            <div className="container mx-auto px-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        Create and Manage AI-powerd Image Designs 
                        </p>
                    </div>
...
// Empty stae when user has no projects
function EmptyState({onCreateProject}) {
    return (
        <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-24 h-24 rounded-full bg-linear-to-r from-blue-500/20 to-purple-600/20 flex items-center justify-center mb-6">
