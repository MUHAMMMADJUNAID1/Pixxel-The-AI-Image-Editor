...
export default function ProjectCard({project,onEdit})  {
    ...
    return (
        <Card className={"py-0 relative bg-slate-800/50 overflow-hidden hover:border-white/20 transition-all hover:transform hover:scale-[1.02]"}>
            {/* Thumbnail */}
            ...
            <div className='absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2'>
                    <Button className={"gap-2"} variant={"galss"} size={"sm"} onClick={onEdit}>
                            Edit
                    </Button>
                    <Button
            variant="glass"
