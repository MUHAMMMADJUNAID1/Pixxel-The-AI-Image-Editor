...
export function NewProjectModal({isOpen,onClose}) {
    ...
    // Handler create projct with plan limit check
    const handleCreateProject =  async() => {
        ...
        if(!selectedFile || !projectTitle.trim()){
            toast.error("Please select an imag and enter a preoject title");
            return;
        }
    ...
    return (
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            ...
            <DialogHeader>
                ...
                <div className='space-y-6'>
                    {/* Project  limt warning for free Users */}
                    {
        ...
        reason= "Free Plan is llmited to 3 projects. Upgrade to Pro for unilimted projects and access to alll AI Editiong top"
        />
        </>
    )
}
