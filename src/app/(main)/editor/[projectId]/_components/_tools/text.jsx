...
export function TextControls () {
    ...
    const updateSelectedText = ()  => {
        ...
        if(activeObject && activeObject.type === "i-text") {
            ...
            setFontFamily(act.fontFamily || "Arial");
    ...
    /// Apply text alignment to sleected text
    const applyTextAlign = (alignment) => {
     ...
     const toggleFormat = (format) => {
        ...
        switch (format) {
          ...
          canvasEditor.requestRenderAll();
          setChanged((c) => c + 1); // Force rerendr to update buttons
     }
        ...
        <div className="space-y-6">
         ...
         <div className="space-y-4">
            <div >
                ...
                Click to add editable text to your canvas</p>
            </div>
            <Button className={"w-full"} onClick={addText} variant={"primary"}>
                <Type className="h-4- w-4 mr-2" />
                Add Text
                </Button>
         </div>

         {/* Text Editing Controls - show only when text is seltedcted */}
         {
            selectedText && (
                <div className="border-t border-white/10 pt-6">
                    ...
                    <div className="space-y-2 mb-4">
                        ...
                        className="w-full px-3 py-2 bg-slate-700 border-white/20 rounded text-white text-sm"
                        >
                    ...
                    <div className="space-y-2 mb-4">
                        ...
                        className={"w-20 h-10 rounded border border-white/20 bg-transparent cursor-pointer"}
                        />
                        </div>
                    </div>
         ...
         {/* Instructions */}
            ...
            any text to edit it directly on canvas.
            <br />
