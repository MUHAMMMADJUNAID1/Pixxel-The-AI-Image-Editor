...
import { EditorSidebar } from "./_components/editor-sidebar.jsx";
import CanvasEditor from "./_components/canvas";

export default function EditorPage() {
    const params = useParams();
    const projectId = params.projectId; // Remove await - useParams is synchronous
    ...
    if(isLoading) {
        return (
            <div className="min-h-screen bg-slate-900 items-center justify-center flex">
