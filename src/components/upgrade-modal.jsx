        ...
        <Dialog open={isOpen} onOpenChange={onClose} >
            ...
            <DialogHeader>
             ...
             <div className='space-y-6'>
                 ...
                 {
                    restrictedTool && (
                        <Alert className={"bg-amber-500/10 boder-amber-500/20"}>
                            ...
                            {
                                reason || 
                                `${getToolName(restrictedTool)} is Only available oo the Pro Plan. Upgrade now to unlock this powerful features and more.`
                            }
                            </AlertDescription>
                        </Alert>
                    )
